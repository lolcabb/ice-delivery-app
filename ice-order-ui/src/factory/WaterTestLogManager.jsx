        ...
        <div className="p-0 sm:p-2 lg:p-4">
            <div className="max-w-7xl mx-auto">
                ...
                {showDashboard && (
                    <div className="mb-6">
                        {/* Danger Alerts */}
                        {dashboardData.dangerousValues.length > 0 && (
                            <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {dashboardData.dangerousValues.slice(0, 4).map((alert, idx) => (
                                        <div key={idx} className="bg-white rounded-lg p-4 border border-red-200">
                                            ...
                                            <div className="mt-2">
                                                <p className="text-sm text-red-700">
                                                    {alert.parameter.replace('_', ' ').toUpperCase()}: <strong>{alert.value}</strong> {alert.threshold.unit}
                                                </p>
                            ...
                            <div className="bg-white rounded-lg shadow-sm p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-2xl font-semibold text-gray-900">{dashboardData.averages.ph_value || 'N/A'}</p>
                            ...
                            <div className="bg-white rounded-lg shadow-sm p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-2xl font-semibold text-gray-900">{dashboardData.averages.tds_ppm_value || 'N/A'} ppm</p>
                                        <p className="text-xs text-gray-500">Safe range: 0 - 500 ppm</p>
                                    </div>
                            ...
                            <div className="bg-white rounded-lg shadow-sm p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-2xl font-semibold text-gray-900">{dashboardData.averages.ec_us_cm_value || 'N/A'} µS/cm</p>
                                        <p className="text-xs text-gray-500">Safe range: 0 - 1000 µS/cm</p>
                                    </div>
